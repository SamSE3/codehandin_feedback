...
/**
 * Strings for component 'feedback_codehandin', language 'en'
 *
...
$string['batchoperationconfirmCHIGS'] = 'confirm grade selected';
$string['batchoperationconfirmCHIGA'] = 'confirm grade all';
